...
connection = sqlite3.connect('myown_data.db')
...
cur.execute("""INSERT OR IGNORE INTO users(userid, firstname, lastname, gender)
...
more = [('00003', 'Peter', 'Parker', 'Male'), ('00004', 'Bruce', 'Wayne', 'male')]

cur.executemany("INSERT OR IGNORE INTO users VALUES (?, ?, ?, ?);", more)
connection.commit()
...
#
# cur.execute("SELECT * FROM users;")
# three_results = cur.fetchmany(20)
# print(three_results)

# cur.execute("""SELECT *, users.firstname, users.lastname FROM orders
